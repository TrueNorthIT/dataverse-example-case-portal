...
1. **Register a SPA application** in your Microsoft Entra External ID (CIAM) tenant. Follow [`dataverse-contact-api/docs/SETUP-AUTH.md`](https://github.com/TrueNorthIT/dataverse-contact-api/blob/main/docs/SETUP-AUTH.md). Grant the SPA the API's access scope (e.g. `api://<api-app-id>/access_as_user`).
